...
export default function AppLayout() {
    return (
        <div className="flex h-screen w-full flex-col bg-neutral-50 dark:bg-neutral-950 font-sans text-neutral-900 dark:text-neutral-100 selection:bg-indigo-500/30">
            {/* Header */}
            <header className="flex h-16 shrink-0 items-center justify-between border-b border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 px-6 backdrop-blur-md">
                <div className="flex items-center gap-8">
                    ...
                    <nav className="flex items-center gap-1 text-sm font-medium">
                        <NavLink
                            to="/"
                            className={({ isActive }) =>
                                `rounded-md px-3 py-2 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800 ${isActive ? 'bg-neutral-100 text-indigo-600 dark:bg-neutral-800 dark:text-indigo-400' : 'text-neutral-600 dark:text-neutral-400'
                                }`
                            }
                        >
                            Dashboard
