  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-24 right-6 z-40 w-72 rounded-2xl border border-neutral-200 bg-white shadow-2xl dark:border-neutral-800 dark:bg-neutral-900 [html[data-exporting='true']_&]:hidden"
      >
        {/* Header */}
