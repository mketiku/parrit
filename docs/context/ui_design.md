...
_The visual direction for this system is defined by the "Human Modern" layout, which prioritizes tactile surfaces and soft, clear interactions._
...
- **The "Ghost" Pencil**: A low-opacity edit icon that only appears on hover over editable text blocks (goals), providing a "scent of information" without visual clutter.
